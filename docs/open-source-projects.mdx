...
export const projectsData = [
	...
	},
	{
		...
		website: [
			{ title: 'Website', link: 'https://www.protonchain.com/', image: '/img/proton.webp'},
	...
	},  
	{
		...
		website: [
			{title: 'Website', link:'https://notarize.edenia.cloud/dashboard/notary', name:'Digital Notary Smart Contract'}
		],
		github: [
	...
	<Grid item md={8} xs={12}>
		<Grid className="content">
			...
			{ projectsData[0].website.map((web, i)=>( 
				<ul key={i}><li><p><strong>{web.title}: </strong>
					<a href={web.link}>{web.name}</a>
				</p></li></ul>
			))}
			{  projectsData[0]?.github && projectsData[0].github.map((git, i)=>( 
				<ul key={i}><li><p><strong>GitHub: </strong>
					<a href={git.link}><img src={git.image} 
					alt={"Link to "+projectsData[0].name+" Github repository"}/></a>
				</p></li></ul>
			))}
		</Grid>
				...
				<tr>
					{  eosio_networks_data.map((network, i)=>( 
						<td><a href={network.href}>
							<img src={network.image} width="30%" alt={network.name+" logo"}/>
						</a></td>
					))}
				</tr>
			</tbody></table>
		...
		<Grid className="content">
			...
			{ projectsData[2].website.map((web, i)=>( 
				<ul key={i}><li><p><strong>{web.title}: </strong>
					{ web.image ? (
						<a href={web.link}>
							<img src={web.image} width="9%" 
							alt={projectsData[2].name + " website icon"}
							loading="lazy"/>
						</a>
					) : (
						<a href={web.link}>{web.name}</a>
