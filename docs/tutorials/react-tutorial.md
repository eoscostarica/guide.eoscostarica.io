...
EOS Costa Rica uses [Storybook EOS Costa Rica](https://github.com/eoscostarica/eosio-components/tree/master/.storybook) for the creation of its components. To use these `eoscr-components` components we leave you the installation guide in [this site](https://www.npmjs.com/package/@eoscostarica/eoscr-components#installation).
