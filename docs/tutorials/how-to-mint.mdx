...
export const atomicHubStepper = [
  ...
  {
    instruction:
      "Create a new schema for your asset. This is the preamble used for expose your crypto-item. Add a new atribute isn't necessary.",
  ...
  {
    instruction:
      'Back to "NFT creator" and click on the new collection to list your item. You will be able to set the sell price. Confirm the transanction.',
